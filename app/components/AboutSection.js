...
const AboutSection = () => {
  return (
    <>
      <div className="py-10">
        <h2 className="gradient-text text-6xl font-bold text-center pb-10 max-[915px]:text-3xl">
          About Me
        </h2>
        ...
        <div className="mt-5 flex justify-center gap-x-2 m-auto w-[50%] text-2xl max-[915px]:text-xl">
